...
<html>
    <head>
        ...
        <title>Welcome ${name} - Upload Videos</title>
    </head>
    <body id="page-top">
         <%
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages3" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="uploadvideos.jsp">Videos</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="showtest.jsp">Test</a>
                    </div>
                </div>
            </li>
                    ...
                    <div >
                        ...
                        <div class="container ">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 class="h3 mb-3 text-gray-800">Upload Videos</h1>
                                    
                            </div>
                            <form action="../uploadvideo" method="post" enctype="multipart/form-data" autocomplete="off">
                                <div class="mb-3 row">
                                  ...
                                  <select class="form-select" name="choosesubject" >
                                    ...
                                    <div class="row ">
                                        <div class="col-lg-6 mb-3">
                                            <label for="totalmarks" class="col-form-label">File Name</label>
                                            <input type="text" class="form-control" id="totalmarks" name="filename" >
                                        </div>
                                        <div class="col-lg-6 mb-3">
                                            <label for="totalmarks" class="col-form-label">Class</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" accept="video/*" name="file" class="form-control" id="formFile" required="required"/><br/><br/>
                                    </div>
                                    <div class="d-grid">
