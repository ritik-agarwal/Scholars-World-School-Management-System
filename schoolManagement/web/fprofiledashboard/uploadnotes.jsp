...
<html>
    <head>
        ...
        <title>Welcome ${name} - Upload Notes</title>
    </head>
    <body id="page-top">
         <%
 ...
 <!-- Nav Item - Pages Collapse Menu -->
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages3" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="uploadnotes.jsp">Notes</a>
                    ...
                    <div >
                        ...
                        <div class="container ">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 class="h3 mb-3 text-gray-800">Upload Notes</h1>
                                    
                            </div>
                            <form action="../uploadnotes" method="post" enctype="multipart/form-data" autocomplete="off">
                                <div class="mb-3 row">
