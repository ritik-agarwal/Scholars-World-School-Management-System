...
<%
                                            ...
                                            try{
                                                ...
                                                db2.pstmt=db2.con.prepareStatement("select firstname,lastname,password,account_type from login where mail ='"+loginid+"' ");
                                                db2.rst=db2.pstmt.executeQuery();
                                                if(db2.rst.next()){
                                                String fstname = db2.rst.getString(1);
                                                String lstname = db2.rst.getString(2);
                                                String passwd = db2.rst.getString(3);
                                                String actype=db2.rst.getString(4);

                                                    session.setAttribute("firstname",fstname);
                                                    session.setAttribute("lastname",lstname);
                                                    session.setAttribute("pswd",passwd);
                                                    session.setAttribute("atype",actype);
                    ...
                    <div class="container">
                        ...
                        <div class="registrationform">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <form id="registerfaculty" action="details.jsp" method="post" autocomplete="off" class="needs-validation" novalidate>
                            
                                        <div >
                                            <div class="mb-3">
                                                <label for="validationCustom05">First Name</label>
                                                <div class="input-group mb-3">
                                                    <input name="fname" type="text" value="<%= session.getAttribute("firstname")%>" class="form-control" id="validationCustom05" required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input name="lname" type="text" value="<%= session.getAttribute("lastname")%>" class="form-control" id="validationCustom06" required>
                                                    <div class="invalid-feedback">
                                                        Enter Last Name
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input name="pswd" type="password" class="form-control" id="validationCustom07" required>
                                                    <div class="invalid-feedback">
                                                        Enter Password
                                                    </div>
                                                </div>
