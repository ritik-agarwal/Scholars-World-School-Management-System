            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="admissionenquiry.jsp">View</a>
                    </div>
                </div>
            </li>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <%
                              try{
                                  ...
                                  db.rst=db.stmt.executeQuery("select firstname,lastname,fathername,fatheroccu,city,state,mobile,class from enquiry");
                                  ...
                                  if(db.rst.next()== false){
                                      ...
                                      <tbody>
                                        <tr>
                                          <th scope="row"><%= db.rst.getString(1)%></th>
