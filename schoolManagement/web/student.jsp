...
<html>
 ...
 <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="studentdashboard/todoAssignment.jsp">Todo Assignment</a>
                        <a class="collapse-item" href="studentdashboard/uploadAssignment.jsp">Upload</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="studentdashboard/notes.jsp">Notes</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="studentdashboard/test.jsp">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Scholar World 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
