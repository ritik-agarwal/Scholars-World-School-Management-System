...
<html>
    <head>
        ...
        <title>Welcome ${name} - Notes</title>
    </head>
    <body id="page-top">
         <%
            ...
            <li class="nav-item  active">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item  active" href="notes.jsp">Notes</a>
                    </div>
                </div>
            </li>
                          ...
                          <thead>
                            ...
                            <%
                              try{
                                  ...
                                  db.rst=db.stmt.executeQuery("select subject,filename,added_date from notes where class='"+session.getAttribute("clas")+"' ");
                                  if(db.rst.next()){do{%>
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td><%=db.rst.getTimestamp(3)%></td>
                                          <td><a href="../downloadnotes?fileName=<%=db.rst.getString(2)%>">Download</a></td>
