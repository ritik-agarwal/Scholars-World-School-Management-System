...
<html>
    <head>
        ...
        <title>Welcome ${name} - Upload Assignment</title>
    </head>
    <body id="page-top">
         <%
 ...
 <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="uploadAssignment.jsp">Upload</a>
  ...
  <div class="container-fluid">
       <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <!-- End of Topbar -->
                <div class="container">
                     <form action="../studentassignmentupload" method="post" enctype="multipart/form-data" autocomplete="off">
                                <div class="mb-3 row">
                                    <div class="col-lg-6">
                                            ...
                                            <div >
                                              <select class="form-select" name="choosesubject" >
                                                    ...
                                                    <%
                                                        ...
                                                        try{
                                                             DBCon db = new DBCon();
                                                             String sql="SELECT subject from data";
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="text" class="form-control " name="class" value="<%= session.getAttribute("clas")%>"  disabled readonly>
                                                </div>
                              </div>
