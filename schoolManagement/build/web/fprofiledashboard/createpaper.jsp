...
<html>
    <head>
        ...
        <title>Welcome ${name} - Assign Paper</title>
    </head>
    <body id="page-top">
         <%
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="createpaper.jsp">Assign Paper</a>
  ...
  <!--Image lgani h -->            
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Create Paper</h1>
                    ...
                    <div class="container p-3">
                        <form action="assigndbpaper.jsp" method="post" autocomplete="off">
                              <div class="mb-2 row">
                              ...
                              <div class="mb-3 row">
                                  <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="totalmarks" name="cls" >
                                  </div>
                                  <div class="col-lg-6">
                                    ...
                                    <hr>    
                                    <div class="d-grid">
                                        <button class="btn btn-primary">Assign Paper</button>
                                    </div>
