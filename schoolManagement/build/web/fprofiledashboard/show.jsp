                          ...
                          <thead>
                            ...
                            <%
                              try{
                                  ...
                                  db.rst=db.stmt.executeQuery("select firstname,lastname,added_date,filename from studentuploaddata where subject='"+sub+"' and class='"+cls+"'");
                                  if(db.rst.next()){do{%>
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td><a href="../downloadstudentassignment?fileName=<%=db.rst.getString(4)%>">Download</a></td>
