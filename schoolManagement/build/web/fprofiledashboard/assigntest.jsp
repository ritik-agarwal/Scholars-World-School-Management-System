...
<html>
    <head>
        ...
        <title>Welcome ${name} - Assign Test</title>
    </head>
    <body id="page-top">
         <%
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="assigntest.jsp">Assign Test</a>
  ...
  <!--Image lgani h -->            
                ...
                <div class="container-fluid">
                    ...
                    <div class="container p-3">
                        <form action="assigndbtest.jsp" method="post" autocomplete="off">
                              <div class="mb-2 row">
                              ...
                              <div class=" row">
                                  <div class="col-lg-6">
                                      <label for="class" class="col-form-label">Class</label>
                                        <div >
                                          <input type="text" class="form-control" id="cls" name="class" >
                                        </div>
                                  </div>
                                  <div class="col-lg-6">
