...
<html>
    <head>
        ...
        <title>Welcome ${name} - Assign Assignment</title>
    </head>
    <body id="page-top">
         <%
            ...
            <li class="nav-item  active">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item  active" href="createassignment.jsp">Upload Assignment</a>
                    ...
                    <div >
                        ...
                        <div class="container ">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 class="h3 mb-3 text-gray-800">Assign Assignment</h1>
                                    
                            </div>
                            <form action="../uploadpdf" method="post" enctype="multipart/form-data" autocomplete="off">
                                <div class="mb-3 row">
                                    <div class="col-lg-6">
                                        <label for="subjectname" class="col-form-label">Subject Name</label>
                                            <div >
                                              <select class="form-select" name="choosesubject" >
                                                    <option selected disabled >Choose...</option>
                                                    <%
                                                        //ArrayList list=new ArrayList();
                                                        try{
                                                             DBCon db = new DBCon();
                                                             String sql="SELECT subjects from subject";
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="text" class="form-control" id="totalmarks" name="class" >
                                                </div>
                              </div>
                                    <div class="row ">
                                        <div class="col-lg-4 mb-3">
                                            <label for="totalmarks" class="col-form-label">Total Marks</label>
                                            <input type="text" class="form-control" id="totalmarks" name="tm" >
                                        </div>
                                        <div class="col-lg-4 mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="file" class="form-control" id="formFile" required="required"/><br/><br/>
                                    </div>
                                    <div class="d-grid">
                                        <button class="btn btn-primary">Assign Assignment</button>
                                    </div>
