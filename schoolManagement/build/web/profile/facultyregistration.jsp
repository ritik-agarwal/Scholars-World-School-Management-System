                        ...
                        <div class="registrationform">
                            ...
                            <div class="form-row">
                              <div class="col-md-6 mb-3">
                                ...
                                <input name="firstname" placeholder="First Name" type="text" class="form-control" minlength="2" id="validationCustom01" required>
                              ...
                              <div class="col-md-6 mb-3">
                                ...
                                <input name="lastname" type="text" placeholder="Last Name" class="form-control" minlength="2" id="validationCustom02" required>
                                <div class="valid-feedback">
                                  Looks good!
                                </div>
                              </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input name="dob" type="date" id="birthday" onkeydown="return false" min="1985-01-01" max="2000-12-31" > 
                                </div>
                              <div class="col-md-3 mb-3">
