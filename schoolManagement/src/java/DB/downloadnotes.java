 ...
 */
@WebServlet(name = "downloadnotes", urlPatterns = {"/downloadnotes"})
public class downloadnotes extends HttpServlet {

    public static int BUFFER_SIZE = 1024 * 100;
    public static final String UPLOAD_DIR = "facultyuploadnotes";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (fileName == null || fileName.equals("")) {
           ...
           // response.getWriter().println("<h3>File " + fileName + " Is Not Present .....!</h3>");
            ...
            String downloadPath = "F:\\schoolManagement\\web\\facultyuploadnotes";
