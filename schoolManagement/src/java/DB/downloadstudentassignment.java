 ...
 */
@WebServlet(name = "downloadstudentassignment", urlPatterns = {"/downloadstudentassignment"})
public class downloadstudentassignment extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (fileName == null || fileName.equals("")) {
           ...
           // response.getWriter().println("<h3>File " + fileName + " Is Not Present .....!</h3>");
            ...
            String downloadPath = "F:\\schoolManagement\\web\\studentuploadwork";
