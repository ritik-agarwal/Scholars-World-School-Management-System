...
public class uploadnotes extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String folderName = "facultyuploadnotes";
            String uploadPath = "F:\\schoolManagement\\web\\facultyuploadnotes";//for netbeans use this code
          ...
          //  System.out.println("Name: " + firstName);
            ...
            try {
                DBCon db = new DBCon();
                String sql = "insert into notes(subject,filename,class,path,added_date) values(?,?,?,?,?)";
                ...
                if (status > 0) {
                    ...
                    response.sendRedirect("fprofiledashboard/uploadnotes.jsp");
